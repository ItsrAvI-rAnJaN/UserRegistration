    ...
    public class Validation
    {
        public string Name(string name)
        {
            ...
            try
            {
                ...
                {
                    throw new CustomExecption(CustomExecption.ExceptionType.EMPTY_STRING, "Name should not be empty");
                }
                if (enteredName.Equals(null))
                {
                    throw new CustomExecption(CustomExecption.ExceptionType.NULL_STRING, "Name should not be ull");
                }
                ...
                {
                    throw new CustomExecption(CustomExecption.ExceptionType.INVALID_STRING, "Name should be valid");
                }
            }
        ...
        public string Email(string email)
        {
            ...
            try
            {
                if (email.Equals(""))
                {
                    throw new CustomExecption(CustomExecption.ExceptionType.EMPTY_STRING, "Email should not be empty");
                }
                if (email.Equals(null))
                {
                    throw new CustomExecption(CustomExecption.ExceptionType.NULL_STRING, "Email should not be ull");
                }
                ...
                {
                    throw new CustomExecption(CustomExecption.ExceptionType.INVALID_STRING, "Email should be valid");
                }
            }
            catch (NullReferenceException ex)
            {
        ...
        public string MobileNumber()
        {
            ...
            try
            {
                ...
                {
                    throw new CustomExecption(CustomExecption.ExceptionType.EMPTY_STRING, "Mobile number not be empty");
                }
                if (enteredMobileNumber.Equals(null))
                {
                    throw new CustomExecption(CustomExecption.ExceptionType.NULL_STRING, "Mobile number not be ull");
                }
                ...
                {
                    throw new CustomExecption(CustomExecption.ExceptionType.INVALID_STRING, "Mobile number be valid");
                }
            }
            catch (NullReferenceException ex)
            {
